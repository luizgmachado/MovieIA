...
const data = {
  "page": 1,
    "results": [
      ...
      "total_pages": 39497,
        "total_results": 789937
}
// puxar informaçoes extras do filme
...
function select3Videos(results) {
  ...
  let selectdVideos = new Set()
  while (selectdVideos.size <= 3) {
    selectdVideos.add(results[random()])
  }
...
function start() {
  ...
  const best3 = Math.random()
  // pegar informaçoes extras dos 3 filmes
  // organizar os dados para ...
  // subistiruir o conteudo dos movies la do html
}